...
class TurbineStageStreamline:
    ...
    def calc_losses(self):
        ...
        self.Y_p_N = float(am_nozz.nozzle_Y(sc, np.deg2rad(beta))) # from correlation for stator
        self.Y_p_R = float(am_imp .nozzle_Y(sc, np.deg2rad(beta))) # from correlation for rotor
